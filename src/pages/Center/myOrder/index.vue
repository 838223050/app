              ...
              <th colspan="5">
                <span class="ordertitle"
                  ...
                  <span class="pull-right delete"
                    ><img :src="item.imgUrl" style="width: 100px" /></span
                ></span>
              </th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="good in item.orderDetailList" :key="good.id">
              <td width="60%">
              ...
              <td rowspan="1" width="13%" class="center">
                <ul class="unstyled">
                  <li class='price'>总金额¥{{ good.orderPrice * good.skuNum }}</li>
                  <li>在线支付</li>
                </ul>
              </td>
              <td rowspan="1" width="8%" class="center">
...
export default {
  ...
  mounted() {
    this.$api
      .reqOrderList(this.page, this.limit)
      .then((res) => {
        if (res.code == 200) {
