  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p>
          ...
          <span class="s3" v-show="address.isDefault == '1'">使用地址</span>
        </p>
      </div>
      <div
      ...
      <div class="address clearFix">
        <span
          class="username"
          :class="{ selected: pay == 0 }"
          @click="changePayWay(0)"
          >在线支付</span
        >
        <span
          class="username"
          :class="{ selected: pay == 1 }"
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        <span v-show="defaultAddress.consignee">
          收货人：{{ defaultAddress.consignee }}</span
        >
        <span v-show="defaultAddress.phoneNum">{{
...
export default {
  ...
  mounted() {
    this.$store.dispatch("getUserAddressInfo").then(() => {
      this.addressInfo.forEach((item, index) => {
        if (item.isDefault == "1") this.defaultIndex = index;
      });
    });
  ...
  computed: {
    ...
    defaultAddress() {
      if (this.addressInfo[this.defaultIndex])
        return this.addressInfo[this.defaultIndex];
      else return { fullAddress: "未选择收货地址" };
    },
  },
  methods: {
    changeAddress(targetindex) {
      this.defaultIndex = targetindex;
    ...
    submitOrder() {
      ...
      let data = {
        ...
        consigneelTel: this.defaultAddress.phoneNum,
